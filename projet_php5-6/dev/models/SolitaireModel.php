...
class SolitaireModel extends A_Model{
    ...
    protected function isValidBoard(array $board){
        ...
        $dimXcount = array_reduce($board, function($acc, $arr){
            if(is_array($arr))
    ...
    public function won(){
        $board = $this->getBoard();
        return array_reduce($board, function($acc, array $row){
            return array_reduce($row, function($count, $col){
     ...
     * @return bool
     */
    protected function isValidXcoordinate($x){
     ...
     * @return bool
     */
    protected function isValidYcoordinate($y){
     ...
     * @return bool
     */
    protected function isValidCoordinate($x, $y){
     ...
     * @return mixed
     */
    public function isInvalidPosition($x, $y){
     ...
     * @return bool
     */
    public function canGo($cx, $cy, $nx, $ny){
     ...
     * @return bool
     */
    protected function invalidDeltas($dx, $dy){
        $dx = abs($dx);
        $dy = abs($dy);
     ...
     * @return bool
     */
    protected function intermediateIsPawn($cx, $cy, $nx, $ny){
        if(!($this->isValidCoordinate($cx, $cy) && $this->isValidCoordinate($nx, $ny)))
            throw new InvalidArgumentException("Invalid coordinates");
     ...
     * @param int $ny being the y-coordinate of the next position
     */
    public function move($cx, $cy,  $nx, $ny){
     ...
     * @return SolitaireModel
     */
    public function addBackup(array $board){
        $bkp = $this->getBackups();
        $bkp[] = $board;
        $this->setBackups($bkp);
        return $this;
     ...
     * @return SolitaireModel
     */
    public function deleteLastBackup(){
        $bkp = $this->getBackups();
        array_pop($bkp);
        $this->setBackups($bkp);
        return $this;
    ...
    //Cheats/debug zone
    public function getInstantLosingBoard(){
        return [
    ...
    public function getInstantWinBoard(){
        return [
            [false, false, false, false, false, false, false],
            [false, false, false, false, false, false, false],
            [false, false, false, false, false, false, false],
    ...
    public function getWinningBoard(){
        return [
            [false, false, false, false, false, false, false],
            [false, false, false, false, false, false, false],
            [false, false, false, false, false, false, false],
    ...
    public function getLosingBoard(){
        return [
            [false, false, false, false, false, false, false],
            [false, false, false, false, false, false, false],
            [false, false, false, false, false, false, false],
