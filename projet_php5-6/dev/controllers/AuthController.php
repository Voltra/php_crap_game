...
class AuthController extends A_Controller {
     ...
     * @return bool
     */
    protected function passwordMatches($username, $pwd){
     ...
     */
    protected function registerUserInDatabase($username, $password){
     ...
     * @throws Exception
     */
    protected function getLoginValidationScheme(){
     ...
     * @throws Exception
     */
    protected function getRegisterValidationScheme(){
     ...
     * @throws Exception
     */
    protected function getValidationSchemeFor($name){
        $session = new Session();
     ...
     * @return bool
     */
    protected function followsFormat($str, array $rules){
        $re = $rules["regex"];
        $regex = "/" . $re . "/";
     ...
     * @return bool
     */
    protected function minLength($str, array $rules){
     ...
     * @return bool
     */
    protected function maxLength($str, array $rules){
     ...
     * @return bool
     */
    protected function sameAs($lhs, $rhs){
        return $lhs === $rhs;
    }
     ...
     * @throws Exception
     */
    protected function loginUsernameValidated($username){
     ...
     * @throws Exception
     */
    protected function loginPasswordValidated($password){
     ...
     * @throws Exception
     */
    protected function registerUsernameValidated($username){
     ...
     * @throws Exception
     */
    protected function registerPasswordValidated($password){
     ...
     * @throws Exception
     */
    protected function registerConfirmPasswordValidated($c_password, $password){
