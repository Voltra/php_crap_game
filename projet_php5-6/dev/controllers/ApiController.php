...
class ApiController extends A_Controller {
    ...
    public function username_available(Request $rq, Router $router, $username=null){
        if(is_null($username))
    ...
    public function victories(Request $rq, Router $router, $username=null){
    ...
    public function stats(Request $rq, Router $router, $username=null){
