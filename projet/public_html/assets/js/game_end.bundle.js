...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {__webpack_require__(6);var _removeSpinnerLord=__webpack_require__(5),_highchartsLoader=__webpack_require__(25);(0,_removeSpinnerLord.removeSpinnerLord)(function(){},100,500),$(function(){var a=$("#chart").data("pie");_highchartsLoader.Highcharts.chart("chart",{chart:{plotBackgroundColor:null,plotBorderWidth:null,plotShadow:!1,type:"pie",backgroundColor:null,borderColor:null},title:{text:a.title},tooltip:{pointFormat:""},plotOptions:{pie:{allowPointSelect:!0,cursor:"pointer",dataLabels:{enabled:!0,format:"<b>{point.name}</b>"},style:{color:_highchartsLoader.Highcharts.theme&&_highchartsLoader.Highcharts.theme.contrastColor||"black"}}},series:[{name:"Lobbies",type:"pie",colorByPoint:!0,data:a.points}]})});
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:!0}),exports.Highcharts=void 0;var _highcharts=__webpack_require__(26),Highcharts=_interopRequireWildcard(_highcharts);function _interopRequireWildcard(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&(b[c]=a[c]);return b.default=a,b}exports.Highcharts=Highcharts;
