...
"use strict";
Object.defineProperty(exports,"__esModule",{value:!0}),exports.getStyles=exports.setupFormValidation=exports.removeSpinnerLord=void 0;var _flash=__webpack_require__(2),_flash2=_interopRequireDefault(_flash),_removeSpinnerLord=__webpack_require__(9),_setupFormValidation=__webpack_require__(10),_setupFormValidation2=_interopRequireDefault(_setupFormValidation),_getStyles=__webpack_require__(0),_getStyles2=_interopRequireDefault(_getStyles);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}exports.removeSpinnerLord=_removeSpinnerLord.removeSpinnerLord,exports.setupFormValidation=_setupFormValidation2.default,exports.getStyles=_getStyles2.default;
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=setupFormValidation;var _fetch_json=__webpack_require__(11),_fetch_json2=_interopRequireDefault(_fetch_json),_yavljs=__webpack_require__(13),_yavljs2=_interopRequireDefault(_yavljs),_getStyles=__webpack_require__(0);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function setupFormValidation(a,b){(0,_fetch_json2.default)(a,function(a){return a}).then(function(a){return(0,_fetch_json2.default)(b,function(b){var c=new _yavljs2.default(a.form,a.fields,b,function validateInput(a){var b=document.querySelector(a);b.innerHTML="";var c=$(b.previousElementSibling),d=c.prev("label"),e=(0,_getStyles.getStyles)("label.valid").color;d.css("color",e),c.css("border","1px solid "+e)},function invalidateInput(a,b,c){a.preventDefault();var d=document.querySelector(b);d.innerHTML=c;var e=$(d.previousElementSibling),f=e.prev("label"),g=$(d).css("color");return f.css("color",g),e.css("border","1px solid "+g),!0}),d=function validateFunc(a){c.validateForm(a);var b=$("p.error"),d=0===b.toArray().filter(function(a){return""!==a.innerHTML}).length;d?$("[type='submit']").removeAttr("disabled"):$("[type='submit']").attr("disabled","disabled")};$(a.form).on("submit",d),$(a.form+" *").on("change keyup",d)})}).catch(function(a){console.log("There has been an error while setting up front-end form validation, falling back to back-end validation."),console.log(a)})}
...
"use strict";
var _setupValidation=__webpack_require__(14),_setupValidation2=_interopRequireDefault(_setupValidation);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}(0,_setupValidation2.default)(100,500,"/assets/json/auth/login/validation.json","/assets/json/auth/login/locale.json");
